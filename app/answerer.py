...
def draft_answer(question: str, documents_dir: Path, top_k: int = 5, method: str = "keyword") -> dict:
    """Return an extractive, citation-bearing answer without calling an LLM."""
